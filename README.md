...
البلاطة حدّدت `data-sh-cover` بنفسها)، و`data-sh-credit` بتتكتب في ركن الصورة.
...
**«تصريحات خاصة»** بقى جوّه عمود المحاور نفسه، تحت الكولكشنات مباشرة
(`sh-index-statements__section-1--in-hubs`) — العمود كان بيفضى جنب الشريط
الجانبي بعد ما بقت المحاور صف واحد.
